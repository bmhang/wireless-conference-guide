...
EXP_DIR="/users/dkulenka/BEOF/expr_descr"
APPS_DIR="/groups/ilabt-imec-be/asu-conf-la/wirelessConfExp/LA_INFR_apps"
EXEC_DIR="/users/dkulenka/BEOF/exec"
...
printf "/users/dkulenka/BEOF/exec *(rw,sync,no_root_squash,no_subtree_check)\n"  | sudo tee -a /etc/exports
printf "/users/dkulenka/BEOF/config *(rw,sync,no_root_squash,no_subtree_check)\n" | sudo tee -a /etc/exports
printf "/users/dkulenka/BEOF/tmp *(rw,sync,no_root_squash,no_subtree_check)\n" | sudo tee -a /etc/exports
